...
vector<Quat> icosahedron = {
  Quat (0.0,  1,         0,          0.323607),		//  0
  Quat (0.0, -1,         0,          0.323607),		//  1
  Quat (0.0,  1,         0,         -0.323607),		//  2
  Quat (0.0, -1,         0,         -0.323607),		//  3
  Quat (0.0,  0,         0.323607,   1      ),		//  4
  Quat (0.0,  0,         0.323607,  -1      ),		//  5
  Quat (0.0,  0,        -0.323607,   1      ),		//  6
  Quat (0.0,  0,        -0.323607,  -1      ),		//  7
  Quat (0.0,  0.323607,  1,          0      ),		//  8
  Quat (0.0, -0.323607,  1,          0      ),		//  9
  Quat (0.0,  0.323607, -1,          0      ),		// 10
  Quat (0.0, -0.323607, -1,          0      )		// 11
};
...
#define VERT_11  rr[11].X (),  rr[11].Y (), rr[11].Z ()
  ...
  glBegin (GL_TRIANGLES); // t 2		// yellow
